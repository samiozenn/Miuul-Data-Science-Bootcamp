...
df = pd.read_csv("4. Hafta Ölçüm Problemleri/Ödevler/RatingProductSortingReviewsinAmazon-221119-111357/Rating Product&SortingReviewsinAmazon/amazon_review.csv")
df["asin"].nunique()
df["overall"].mean()
###################################################
